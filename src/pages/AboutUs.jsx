    ...
    <div>
      ...
      <div className="flex flex-col gap-10 ">
        ...
        <div className="text-start text-xl">
          ...
          platform is always up-to-date with the latest job openings, admit card
          releases, and exam results. <br />
          ...
          information to ensure that you have access to accurate and trustworthy
          data. <br />
          <hr className="p-10" />
        </div>
      </div>
